...
### PortFolio URL : <https://wkdwowns100.github.io/PortFolio/>
...
- #### Home의 3D 큐브 작업 시의 어려움
  - `react의 3d-cube, three 등 의 라이브러리로 구현해야 했으나 지식과 숙련도가 미흡하여 구현하지 못함`
  - `SCSS의 애니메이션으로 대체하여 작성`
  - `애니메이션이 구동되기는 했으나 빛의 방향에 따른 음영이 표현되지 않음`
  - `추후 다른 프로젝트에서 구현해 볼 예정`
